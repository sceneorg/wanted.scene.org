...
<section id="content">
  <div>
    <div id='news'>
<?php
$posts = SQLLib::SelectRows("SELECT * FROM posts LEFT JOIN users ON users.sceneID = posts.userID WHERE closureReason is NULL AND expiry IS NULL OR expiry > NOW() ORDER BY postDate DESC LIMIT 5");
