...
foreach($messages as $message)
{
  ...
  printf("<span class='author'>%s - <time datetime='%s'>%s</time>",_html($message->displayName),$message->postDate,dateDiffReadable(time(),$message->postDate));
...
foreach($threads as $thread)
{
  ...
  printf("<time datetime='%s'>%s</time>",$thread->postDate,dateDiffReadable(time(),$thread->postDate));
